    ...
    <div className={cn("flex items-center gap-2", className)}>
      ...
      >
        <SelectTrigger
          ...
          className="-ml-3 h-8 w-fit border-none text-xs hover:bg-gray-200 hover:text-black data-[state=open]:bg-gray-200 [&>svg:last-child]:hidden"
        >
          {title}
          <SelectIcon asChild>
            ...
            <>
              <SelectItem value={ascValue}>
                <span className="flex items-center">
                  <ArrowUp
                    className="mr-2 size-3.5 text-gray-100"
                    aria-hidden="true"
                  />
                  Naik
                </span>
